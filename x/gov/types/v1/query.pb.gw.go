...
var (
	...
	pattern_Query_SealedProposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cosmos", "gov", "v1", "sealed_proposals", "proposal_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SealedProposals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "gov", "v1", "sealed_proposals"}, "", runtime.AssumeColonVerbOpt(false)))
