...
type TallyParams struct {
	...
	MaxTallyPeriod *time.Duration `protobuf:"bytes,4,opt,name=max_tally_period,json=maxTallyPeriod,proto3,stdduration" json:"max_tally_period,omitempty"`
}
...
func (m *TallyParams) GetMaxTallyPeriod() *time.Duration {
	if m != nil {
...
type Params struct {
	...
	// Duration of the voting period.
	MaxTallyPeriod        *time.Duration         `protobuf:"bytes,16,opt,name=max_tally_period,json=maxTallyPeriod,proto3,stdduration" json:"max_tally_period,omitempty"`
...
func init() {
	...
	proto.RegisterType((*LastProcessedSequence)(nil), "cosmos.gov.v1.LastProcessedSequence")
}
...
var fileDescriptor_e05cb1c0d030febb = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxTallyPeriod != nil {
		n9, err9 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.MaxTallyPeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.MaxTallyPeriod):])
		if err9 != nil {
			return 0, err9
		}
		i -= n9
...
func (m *LastProcessedSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.SeqNo != 0 {
		i = encodeVarintGov(dAtA, i, uint64(m.SeqNo))
		i--
		dAtA[i] = 0x18
	}
	if len(m.PortId) > 0 {
		...
		i = encodeVarintGov(dAtA, i, uint64(len(m.PortId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ChannelId) > 0 {
