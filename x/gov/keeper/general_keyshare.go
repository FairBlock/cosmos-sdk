...
func (k Keeper) GetRequestQueueEntry(
	...
	store := prefix.NewStore(ctx.KVStore(k.storeKey), types.KeyPrefix(types.ReqQueueKeyPrefix))
...
func (k Keeper) GetSignalQueueEntry(
	...
	store := prefix.NewStore(ctx.KVStore(k.storeKey), types.KeyPrefix(types.SignalQueueKeyPrefix))
