...
// SealedTally iterates over the votes and updates the tally of a sealed proposal based on the voting power of the
// voters
func (keeper Keeper) SealedTally(ctx sdk.Context, proposal v1.SealedProposal) (passes bool, burnDeposits bool, tallyResults v1.TallyResult) {
	results := make(map[v1.VoteOption]sdk.Dec)
	results[v1.OptionYes] = sdk.ZeroDec()
	results[v1.OptionAbstain] = sdk.ZeroDec()
	results[v1.OptionNo] = sdk.ZeroDec()
